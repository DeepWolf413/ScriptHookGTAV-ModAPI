...
namespace ModAPI::MMath
{
	...
	Vector3 Vector3::FromSHVector3(const ::Vector3& vector)
	{
	...
	::Vector3 Vector3::ToSHVector3() const
	{
		::Vector3 scriptHookVector3 = ::Vector3();
		scriptHookVector3.x = X;
		scriptHookVector3.y = Y;
		scriptHookVector3.z = Z;
		return scriptHookVector3;
	}
